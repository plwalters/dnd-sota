...
define('durandal/binder',["durandal/system","knockout"],function(e,t){function a(t){return void 0===t?{applyBindings:!0}:e.isBoolean(t)?{applyBindings:t}:(void 0===t.applyBindings&&(t.applyBindings=!0),t)}function n(n,u,l,d){if(!u||!l)return i.throwOnErrors?e.error(r):e.log(r,u,d),void 0;if(!u.getAttribute)return i.throwOnErrors?e.error(o):e.log(o,u,d),void 0;var y=u.getAttribute("data-view");try{var p;return n&&n.binding&&(p=n.binding(u)),p=a(p),i.binding(d,u,p),p.applyBindings?(e.log("Binding",y,d),t.applyBindings(l,u)):n&&t.utils.domData.set(u,c,{$data:n}),i.bindingComplete(d,u,p),n&&n.bindingComplete&&n.bindingComplete(u),t.utils.domData.set(u,s,p),p}catch(m){m.message=m.message+";\nView: "+y+";\nModuleId: "+e.getModuleId(d),i.throwOnErrors?e.error(m):e.log(m.message)}}var i,r="Insufficient Information to Bind",o="Unexpected View Type",s="durandal-binding-instruction",c="__ko_bindingContext__";return i={binding:e.noop,bindingComplete:e.noop,throwOnErrors:!1,getBindingInstruction:function(e){return t.utils.domData.get(e,s)},bindContext:function(e,t,a){return a&&e&&(e=e.createChildContext(a)),n(a,t,e,a||(e?e.$data:null))},bind:function(e,t){return n(e,t,e,e)}}});
...
define('durandal/composition',["durandal/system","durandal/viewLocator","durandal/binder","durandal/viewEngine","durandal/activator","jquery","knockout"],function(e,t,a,n,i,r,o){function s(e){for(var t=[],a={childElements:t,activeView:null},n=o.virtualElements.firstChild(e);n;)1==n.nodeType&&(t.push(n),n.getAttribute(E)&&(a.activeView=n)),n=o.virtualElements.nextSibling(n);return a.activeView||(a.activeView=t[0]),a}function c(){A--,0===A&&setTimeout(function(){for(var t=b.length;t--;)try{b[t]()}catch(a){e.error(a)}b=[]},1)}function l(e){delete e.activeView,delete e.viewElements}function u(t,a,n){if(n)a();else if(t.activate&&t.model&&t.model.activate){var i;try{i=e.isArray(t.activationData)?t.model.activate.apply(t.model,t.activationData):t.model.activate(t.activationData),i&&i.then?i.then(a,function(t){e.error(t),a()}):i||void 0===i?a():(c(),l(t))}catch(r){e.error(r)}}else a()}function d(){var t=this;if(t.activeView&&t.activeView.removeAttribute(E),t.child)try{t.model&&t.model.attached&&(t.composingNewView||t.alwaysTriggerAttach)&&t.model.attached(t.child,t.parent,t),t.attached&&t.attached(t.child,t.parent,t),t.child.setAttribute(E,!0),t.composingNewView&&t.model&&t.model.detached&&o.utils.domNodeDisposal.addDisposeCallback(t.child,function(){try{t.model.detached(t.child,t.parent,t)}catch(a){e.error(a)}})}catch(a){e.error(a)}t.triggerAttach=e.noop}function m(t){if(e.isString(t.transition)){if(t.activeView){if(t.activeView==t.child)return!1;if(!t.child)return!0;if(t.skipTransitionOnSameViewId){var a=t.activeView.getAttribute("data-view"),n=t.child.getAttribute("data-view");return a!=n}}return!0}return!1}function p(e){for(var t=0,a=e.length,n=[];a>t;t++){var i=e[t].cloneNode(!0);n.push(i)}return n}function v(e){var t=p(e.parts),a=h.getParts(t,null,!0),n=h.getParts(e.child);for(var i in a)r(n[i]).replaceWith(a[i])}function y(t){var a,n,i=o.virtualElements.childNodes(t.parent);if(!e.isArray(i)){var r=[];for(a=0,n=i.length;n>a;a++)r[a]=i[a];i=r}for(a=1,n=i.length;n>a;a++)o.removeNode(i[a])}function f(e){o.utils.domData.set(e,D,e.style.display),e.style.display="none"}function g(e){e.style.display=o.utils.domData.get(e,D)}function T(e){var t=e.getAttribute("data-bind");if(!t)return!1;for(var a=0,n=O.length;n>a;a++)if(t.indexOf(O[a])>-1)return!0;return!1}var h,I={},E="data-active-view",b=[],A=0,w="durandal-composition-data",S="data-part",N=["model","view","transition","area","strategy","activationData"],D="durandal-visibility-data",O=["compose:"],C={complete:function(e){b.push(e)}};return h={composeBindings:O,convertTransitionToModuleId:function(e){return"transitions/"+e},defaultTransitionName:null,current:C,addBindingHandler:function(e,t,a){var n,i,r="composition-handler-"+e;t=t||o.bindingHandlers[e],a=a||function(){return void 0},i=o.bindingHandlers[e]={init:function(e,n,i,s,c){if(A>0){var l={trigger:o.observable(null)};h.current.complete(function(){t.init&&t.init(e,n,i,s,c),t.update&&(o.utils.domData.set(e,r,t),l.trigger("trigger"))}),o.utils.domData.set(e,r,l)}else o.utils.domData.set(e,r,t),t.init&&t.init(e,n,i,s,c);return a(e,n,i,s,c)},update:function(e,t,a,n,i){var s=o.utils.domData.get(e,r);return s.update?s.update(e,t,a,n,i):(s.trigger&&s.trigger(),void 0)}};for(n in t)"init"!==n&&"update"!==n&&(i[n]=t[n])},getParts:function(e,t,a){if(t=t||{},!e)return t;void 0===e.length&&(e=[e]);for(var n=0,i=e.length;i>n;n++){var r=e[n];if(r.getAttribute){if(!a&&T(r))continue;var o=r.getAttribute(S);o&&(t[o]=r),!a&&r.hasChildNodes()&&h.getParts(r.childNodes,t)}}return t},cloneNodes:p,finalize:function(t){if(void 0===t.transition&&(t.transition=this.defaultTransitionName),t.child||t.activeView)if(m(t)){var n=this.convertTransitionToModuleId(t.transition);e.acquire(n).then(function(e){t.transition=e,e(t).then(function(){if(t.cacheViews){if(t.activeView){var e=a.getBindingInstruction(t.activeView);e&&void 0!=e.cacheViews&&!e.cacheViews&&o.removeNode(t.activeView)}}else t.child?y(t):o.virtualElements.emptyNode(t.parent);t.triggerAttach(),c(),l(t)})}).fail(function(t){e.error("Failed to load transition ("+n+"). Details: "+t.message)})}else{if(t.child!=t.activeView){if(t.cacheViews&&t.activeView){var i=a.getBindingInstruction(t.activeView);!i||void 0!=i.cacheViews&&!i.cacheViews?o.removeNode(t.activeView):f(t.activeView)}t.child?(t.cacheViews||y(t),g(t.child)):t.cacheViews||o.virtualElements.emptyNode(t.parent)}t.triggerAttach(),c(),l(t)}else t.cacheViews||o.virtualElements.emptyNode(t.parent),t.triggerAttach(),c(),l(t)},bindAndShow:function(e,t,i){t.child=e,t.composingNewView=t.cacheViews?-1==o.utils.arrayIndexOf(t.viewElements,e):!0,u(t,function(){if(t.binding&&t.binding(t.child,t.parent,t),t.preserveContext&&t.bindingContext)t.composingNewView&&(t.parts&&v(t),f(e),o.virtualElements.prepend(t.parent,e),a.bindContext(t.bindingContext,e,t.model));else if(e){var i=t.model||I,r=o.dataFor(e);if(r!=i){if(!t.composingNewView)return o.removeNode(e),n.createView(e.getAttribute("data-view")).then(function(e){h.bindAndShow(e,t,!0)}),void 0;t.parts&&v(t),f(e),o.virtualElements.prepend(t.parent,e),a.bind(i,e)}}h.finalize(t)},i)},defaultStrategy:function(e){return t.locateViewForObject(e.model,e.area,e.viewElements)},getSettings:function(t){var a,r=t(),s=o.utils.unwrapObservable(r)||{},c=i.isActivator(r);if(e.isString(s))return s=n.isViewUrl(s)?{view:s}:{model:s,activate:!0};if(a=e.getModuleId(s))return s={model:s,activate:!0};!c&&s.model&&(c=i.isActivator(s.model));for(var l in s)s[l]=-1!=o.utils.arrayIndexOf(N,l)?o.utils.unwrapObservable(s[l]):s[l];return c?s.activate=!1:void 0===s.activate&&(s.activate=!0),s},executeStrategy:function(e){e.strategy(e).then(function(t){h.bindAndShow(t,e)})},inject:function(a){return a.model?a.view?(t.locateView(a.view,a.area,a.viewElements).then(function(e){h.bindAndShow(e,a)}),void 0):(a.strategy||(a.strategy=this.defaultStrategy),e.isString(a.strategy)?e.acquire(a.strategy).then(function(e){a.strategy=e,h.executeStrategy(a)}).fail(function(t){e.error("Failed to load view strategy ("+a.strategy+"). Details: "+t.message)}):this.executeStrategy(a),void 0):(this.bindAndShow(null,a),void 0)},compose:function(a,n,i,r){A++,r||(n=h.getSettings(function(){return n},a)),n.compositionComplete&&b.push(function(){n.compositionComplete(n.child,n.parent,n)}),b.push(function(){n.composingNewView&&n.model&&n.model.compositionComplete&&n.model.compositionComplete(n.child,n.parent,n)});var o=s(a);n.activeView=o.activeView,n.parent=a,n.triggerAttach=d,n.bindingContext=i,n.cacheViews&&!n.viewElements&&(n.viewElements=o.childElements),n.model?e.isString(n.model)?e.acquire(n.model).then(function(t){n.model=e.resolveObject(t),h.inject(n)}).fail(function(t){e.error("Failed to load composed module ("+n.model+"). Details: "+t.message)}):h.inject(n):n.view?(n.area=n.area||"partial",n.preserveContext=!0,t.locateView(n.view,n.area,n.viewElements).then(function(e){h.bindAndShow(e,n)})):this.bindAndShow(null,n)}},o.bindingHandlers.compose={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,a,i,r){var s=h.getSettings(t,e);if(s.mode){var c=o.utils.domData.get(e,w);if(!c){var l=o.virtualElements.childNodes(e);c={},"inline"===s.mode?c.view=n.ensureSingleElement(l):"templated"===s.mode&&(c.parts=p(l)),o.virtualElements.emptyNode(e),o.utils.domData.set(e,w,c)}"inline"===s.mode?s.view=c.view.cloneNode(!0):"templated"===s.mode&&(s.parts=c.parts),s.preserveContext=!0}h.compose(e,s,r,!0)}},o.virtualElements.allowedBindings.compose=!0,h});
define('durandal/events',["durandal/system"],function(e){var t=/\s+/,n=function(){},a=function(e,t){this.owner=e,this.events=t};return a.prototype.then=function(e,t){return this.callback=e||this.callback,this.context=t||this.context,this.callback?(this.owner.on(this.events,this.callback,this.context),this):this},a.prototype.on=a.prototype.then,a.prototype.off=function(){return this.owner.off(this.events,this.callback,this.context),this},n.prototype.on=function(e,n,i){var r,o,s;if(n){for(r=this.callbacks||(this.callbacks={}),e=e.split(t);o=e.shift();)s=r[o]||(r[o]=[]),s.push(n,i);return this}return new a(this,e)},n.prototype.off=function(n,a,i){var r,o,s,c;if(!(o=this.callbacks))return this;if(!(n||a||i))return delete this.callbacks,this;for(n=n?n.split(t):e.keys(o);r=n.shift();)if((s=o[r])&&(a||i))for(c=s.length-2;c>=0;c-=2)a&&s[c]!==a||i&&s[c+1]!==i||s.splice(c,2);else delete o[r];return this},n.prototype.trigger=function(e){var n,a,i,r,o,s,c,l;if(!(a=this.callbacks))return this;for(l=[],e=e.split(t),r=1,o=arguments.length;o>r;r++)l[r-1]=arguments[r];for(;n=e.shift();){if((c=a.all)&&(c=c.slice()),(i=a[n])&&(i=i.slice()),i)for(r=0,o=i.length;o>r;r+=2)i[r].apply(i[r+1]||this,l);if(c)for(s=[n].concat(l),r=0,o=c.length;o>r;r+=2)c[r].apply(c[r+1]||this,s)}return this},n.prototype.proxy=function(e){var t=this;return function(n){t.trigger(e,n)}},n.includeIn=function(e){e.on=n.prototype.on,e.off=n.prototype.off,e.trigger=n.prototype.trigger,e.proxy=n.prototype.proxy},n});
...
define('services/datacontext',["models/config.models"],function(e){function a(e,a){var t=m.from("Maps").toType("Map").where("id","==",a);return thisMap=I.executeQueryLocally(t),e(thisMap[0])}function t(e,a,t,n){var i=new u("x","==",a),r=new u("y","==",t),y=new u("mapId","==",n),o=i.and(r,y),d=m.from("Tiles").toType("Tile").where(o),p=I.executeQueryLocally(d);return e?e(p[0]):p[0]}function n(){function e(){var e=I.exportEntities(null,!1);i(e)}var a=m.from("Maps").where("id","!=",1).using(I).toType("Map").executeLocally();e(a)}function i(e){window.localStorage.setItem("dnd-sota",e)}function r(e){e.entityAspect.acceptChanges()}function y(e){var a=new u("image","==","U"),t=new u("mapId","==",e),n=t.and(a),i=m.from("Tiles").toType("Tile").where(n),r=I.executeQueryLocally(i);return r[0]}function o(e){var a=new u("image","==","@"),t=new u("mapId","==",e),n=t.and(a),i=m.from("Tiles").toType("Tile").where(n),r=I.executeQueryLocally(i);return r[0]}function d(e,a,t){var n=T("Position",{x:a,y:t});e.position(n)}function p(e,a,t){var n=T("Position",{x:a,y:t});e.position(n)}function s(e,a){var t=I.createEntity(e,a);return t.entityAspect.acceptChanges(),t}function T(e,a){var t=I.metadataStore.getEntityType(e),n=t.createInstance(a);return n}function c(){breeze.NamingConvention.camelCase.setAsDefault(),breeze.config.initializeAdapterInstance("ajax","jQuery",!0);var a=new breeze.EntityManager({dataService:l});return e.initialize(a.metadataStore),a}var m=breeze.EntityQuery,u=breeze.Predicate,l=new breeze.DataService({adapterName:"webApi",serviceName:"api/breeze",hasServerMetadata:!1}),I=c();I.metadataStore;var f={createEntity:s,createComplexType:T,saveEntity:r,getTileByCoord:t,getMap:a,createPlayerPosition:d,createEnemyPosition:p,findPlayerStart:y,findEnemy:o,saveMapsAndTiles:n};return f});
define('services/game.objects',["services/datacontext"],function(e){function a(a){for(var t=a.layout,n=1,i=1,r=1,y=0;y<t.length;y++){var d=t.charAt(y);if("*"===d)e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!0,x:n,y:i,image:"*"}),n+=1;else if("."===d)e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!1,x:n,y:i,image:" "}),n+=1;else if("U"===d)e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!0,x:n,y:i,image:"U"}),n+=1;else if("$"===d){var d=e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!1,x:n,y:i,image:"$"}),o=e.createComplexType("TileItem",{id:r,name:"GOLD",value:10});d.item(o),r+=1,n+=1}else if("E"===d){var d=e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!1,x:n,y:i,image:"@"});n+=1}else if("D"===d){var d=e.createEntity("Tile",{name:"Tile",mapId:a.id,occupied:!0,x:n,y:i,image:"D"}),o=e.createComplexType("TileItem",{id:r,name:"DOOR"});d.item(o),r+=1,n+=1}else","===d&&(n=1,i+=1)}e.createEntity("Map",{id:a.id,name:a.name})}var t=ko.observableArray([e.createEntity("Weapon",{id:1,name:"SWORD",damage:5,value:10,range:1}),e.createEntity("Weapon",{id:2,name:"2-H-SWORD",damage:5,value:15,range:1}),e.createEntity("Weapon",{id:3,name:"DAGGER",damage:3,value:3,range:3}),e.createEntity("Weapon",{id:4,name:"MACE",damage:6,value:15,range:1}),e.createEntity("Weapon",{id:5,name:"SPEAR",damage:7,value:15,range:5}),e.createEntity("Weapon",{id:6,name:"BOW",damage:3,value:15,range:5})]),n=ko.observableArray([e.createEntity("Armor",{name:"LEATHER MAIL",defense:1,value:15}),e.createEntity("Armor",{name:"CHAIN MAIL",defense:1,value:30}),e.createEntity("Armor",{name:"TLTE MAIL",defense:1,value:50})]),i=ko.observableArray([e.createEntity("TileType",{name:"WALL",designerImage:"*",image:"*"}),e.createEntity("TileType",{name:"EMPTY",designerImage:".",image:" "}),e.createEntity("TileType",{name:"GOLD",designerImage:"$",image:"$"}),e.createEntity("TileType",{name:"ENEMY",designerImage:"E",image:"E"}),e.createEntity("TileType",{name:"DOOR",designerImage:"D",image:"D"}),e.createEntity("TileType",{name:"LINE END",designerImage:",",image:" "})]),r=ko.observableArray([e.createEntity("ClassType",{name:"FIGHTER",startingGold:8}),e.createEntity("ClassType",{name:"CLERIC",startingGold:4}),e.createEntity("ClassType",{name:"WIZARD",startingGold:6})]),y=ko.observableArray([e.createEntity("Attribute",{name:"STRENGTH"}),e.createEntity("Attribute",{name:"DEXTERITY"}),e.createEntity("Attribute",{name:"CON"}),e.createEntity("Attribute",{name:"CHAR"}),e.createEntity("Attribute",{name:"WISDOM"}),e.createEntity("Attribute",{name:"INTELLECT"})]),d=ko.observableArray([e.createEntity("Item",{id:7,name:"ROPE",value:1,canBuy:!0}),e.createEntity("Item",{id:8,name:"SPIKES",value:1,canBuy:!0}),e.createEntity("Item",{id:9,name:"FLASK OF OIL",value:2,canBuy:!0}),e.createEntity("Item",{id:10,name:"SILVER CROSS",value:25,canBuy:!0}),e.createEntity("Item",{id:11,name:"SPARE FOOD",value:5,canBuy:!0}),e.createEntity("Item",{id:12,name:"ARROWS",value:15,quantity:15,canBuy:!0}),e.createEntity("Item",{id:13,name:"GOLD",value:25,canBuy:!1}),e.createEntity("Item",{id:14,name:"DOOR",value:0,canBuy:!1})]);d()[6];var o=ko.observableArray([e.createEntity("Map",{id:1,name:"DND1"})]),p={id:2,name:"Second",layout:"**************,*U...........*,*......E....$*,**D***..******,D............*,*....E......$*,*..***********,*....****....*,*....****....*,*............*,**************"};a(p);var s={weapons:t,armors:n,classTypes:r,attributes:y,items:d,maps:o,tileTypes:i,mapCreator:a};return s});
...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,a,i,r,o,s){function c(e){return e=e.replace(y,"\\$&").replace(v,"(?:$1)?").replace(m,function(e,t){return t?e:"([^/]+)"}).replace(g,"(.*?)"),new RegExp("^"+e+"$")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function l(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,a=e.length;a>n;n++)if(e[n]!=t[n])return!1;return!0}var f,p,v=/\((.*?)\)/g,m=/(\(\?)?:\w+/g,g=/\*\w+/g,y=/[\-{}\[\]+?.,\\\^$|#\s]/g,h=/\/$/,b=function(){function i(e){return e.router&&e.router.parent==_}function s(e){D&&D.config.isActive&&D.config.isActive(e)}function v(t,n){e.log("Navigation Complete",t,n);var a=e.getModuleId(O);a&&_.trigger("router:navigation:from:"+a),O=t,s(!1),D=n,s(!0);var r=e.getModuleId(O);r&&_.trigger("router:navigation:to:"+r),i(t)||_.updateDocumentTitle(t,n),p.explicitNavigation=!1,p.navigatingBack=!1,_.trigger("router:navigation:complete",t,n,_)}function m(t,n){e.log("Navigation Cancelled"),_.activeInstruction(D),D&&_.navigate(D.fragment,!1),k(!1),p.explicitNavigation=!1,p.navigatingBack=!1,_.trigger("router:navigation:cancelled",t,n,_)}function g(t){e.log("Navigation Redirecting"),k(!1),p.explicitNavigation=!1,p.navigatingBack=!1,_.navigate(t,{trigger:!0,replace:!0})}function y(t,n,a){p.navigatingBack=!p.explicitNavigation&&O!=a.fragment,_.trigger("router:route:activating",n,a,_),t.activateItem(n,a.params).then(function(e){if(e){var r=O;if(v(n,a),i(n)){var o=a.fragment;a.queryString&&(o+="?"+a.queryString),n.router.loadUrl(o)}r==n&&(_.attached(),_.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?g(t.settings.lifecycleData.redirect):m(n,a);f&&(f.resolve(),f=null)}).fail(function(t){e.error(t)})}function T(t,n,a){var i=_.guardRoute(n,a);i?i.then?i.then(function(i){i?e.isString(i)?g(i):y(t,n,a):m(n,a)}):e.isString(i)?g(i):y(t,n,a):m(n,a)}function I(e,t,n){_.guardRoute?T(e,t,n):y(e,t,n)}function w(e){return D&&D.config.moduleId==e.config.moduleId&&O&&(O.canReuseForRoute&&O.canReuseForRoute.apply(O,e.params)||!O.canReuseForRoute&&O.router&&O.router.loadUrl)}function E(){if(!k()){var t=C.shift();C=[],t&&(k(!0),_.activeInstruction(t),w(t)?I(n.create(),O,t):e.acquire(t.config.moduleId).then(function(n){var a=e.resolveObject(n);I(P,a,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function A(e){C.unshift(e),E()}function S(e,t,n){for(var a=e.exec(t).slice(1),i=0;i<a.length;i++){var r=a[i];a[i]=r?decodeURIComponent(r):null}var o=_.parseQueryString(n);return o&&a.push(o),{params:a,queryParams:o}}function x(t){_.trigger("router:route:before-config",t,_),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||_.convertRouteToTitle(t.route),t.moduleId=t.moduleId||_.convertRouteToModuleId(t.route),t.hash=t.hash||_.convertRouteToHash(t.route),t.routePattern=c(t.route)),t.isActive=t.isActive||o.observable(!1),_.trigger("router:route:after-config",t,_),_.routes.push(t),_.route(t.routePattern,function(e,n){var a=S(t.routePattern,e,n);A({fragment:e,queryString:n,config:t,params:a.params,queryParams:a.queryParams})})}function N(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),a=0,i=t.route.length;i>a;a++){var r=e.extend({},t);r.route=t.route[a],r.isActive=n,a>0&&delete r.nav,x(r)}else x(t);return _}var O,D,C=[],k=o.observable(!1),P=n.create(),_={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:P,isNavigating:o.computed(function(){var e=P(),t=k(),n=e&&e.router&&e.router!=_&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return a.includeIn(_),P.settings.areSameItem=function(e,t,n,a){return e==t?d(n,a):!1},_.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var a=0;a<n.length;a++){var i=n[a];if(""!==i){var r=i.split("=");t[r[0]]=r[1]&&decodeURIComponent(r[1].replace(/\+/g," "))}}return t},_.route=function(e,t){_.handlers.push({routePattern:e,callback:t})},_.loadUrl=function(t){var n=_.handlers,a=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),a=t.substr(o+1)),_.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(h,"");for(var c=0;c<n.length;c++){var u=n[c];if(u.routePattern.test(i))return u.callback(i,a),!0}return e.log("Route Not Found"),_.trigger("router:route:not-found",t,_),D&&r.navigate(D.fragment,{trigger:!1,replace:!0}),p.explicitNavigation=!1,p.navigatingBack=!1,!1},_.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},_.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(p.explicitNavigation=!0,r.navigate(e,t))},_.navigateBack=function(){r.navigateBack()},_.attached=function(){_.trigger("router:navigation:attached",O,D,_)},_.compositionComplete=function(){k(!1),_.trigger("router:navigation:composition-complete",O,D,_),E()},_.convertRouteToHash=function(e){if(_.relativeToParentRouter){var t=_.parent.activeInstruction(),n=t.config.hash+"/"+e;return r._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return r._hasPushState?e:"#"+e},_.convertRouteToModuleId=function(e){return u(e)},_.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},_.map=function(t,n){if(e.isArray(t)){for(var a=0;a<t.length;a++)_.map(t[a]);return _}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,N(n)},_.buildNavigationModel=function(t){for(var n=[],a=_.routes,i=t||100,r=0;r<a.length;r++){var o=a[r];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),_.navigationModel(n),_},_.mapUnknownRoutes=function(t,n){var a="*catchall",i=c(a);return _.route(i,function(o,s){var c=S(i,o,s),u={fragment:o,queryString:s,config:{route:a,routePattern:i},params:c.params,queryParams:c.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&r.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var l=t(u);if(l&&l.then)return l.then(function(){_.trigger("router:route:before-config",u.config,_),_.trigger("router:route:after-config",u.config,_),A(u)}),void 0}else u.config=t,u.config.route=a,u.config.routePattern=i;else u.config.moduleId=o;_.trigger("router:route:before-config",u.config,_),_.trigger("router:route:after-config",u.config,_),A(u)}),_},_.reset=function(){return D=O=void 0,_.handlers=[],_.routes=[],_.off(),delete _.options,_},_.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!l(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!l(t.route,"/")&&(t.route+="/"),t.fromParent&&(_.relativeToParentRouter=!0),_.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),_},_.createChildRouter=function(){var e=b();return e.parent=_,e},_};return p=b(),p.explicitNavigation=!1,p.navigatingBack=!1,p.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},p.activate=function(t){return e.defer(function(n){if(f=n,p.options=e.extend({routeHandler:p.loadUrl},p.options,t),r.activate(p.options),r._hasPushState)for(var a=p.routes,i=a.length;i--;){var o=a[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(r._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&p.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(p.explicitNavigation=!0,e.preventDefault(),r.navigate(t))}}else p.explicitNavigation=!0}),r.options.silent&&f&&(f.resolve(),f=null)}).promise()},p.deactivate=function(){r.deactivate()},p.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,a,r){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var c=o.utils.unwrapObservable(s.router||a.router)||p;s.model=c.activeItem(),s.attached=c.attached,s.compositionComplete=c.compositionComplete,s.activate=!1}i.compose(e,s,r)}},o.virtualElements.allowedBindings.router=!0},p});
define('viewmodels/gameStart/character.create',["services/session","services/game.objects","plugins/router","services/datacontext"],function(e,a,t,n){function i(){c(!0)}function r(){if(d()&&d().name()){if("shavs"===d().name().toLowerCase())return n.saveEntity(d()),s(2),c(!1),m(!0),d().strength(o(15,15)),d().dexterity(o(15,15)),d().constitution(o(15,15)),d().charisma(o(15,15)),d().wisdom(o(15,15)),d().intellect(o(15,15)),d().gold(15*o(15,15)),d().hitPoints(o(8,8)),!0;n.saveEntity(d()),s(2),c(!1),m(!0),d().strength(o(1,15)),d().dexterity(o(1,15)),d().constitution(o(1,15)),d().charisma(o(1,15)),d().wisdom(o(1,15)),d().intellect(o(1,15)),d().gold(15*o(10,15)),d().hitPoints(o(2,8))}}function o(e,a){return Math.random()*(a-e)+e}function y(){if(!d()||!l())return m(!0),!1;var i=ko.utils.arrayFirst(a.classTypes(),function(e){return e.name().toLowerCase()===l().toLowerCase()});return i?(d().classType(i),n.saveEntity(d()),e.currentPlayer(d()),t.navigate("purchase")):(l(null),void 0)}var d=ko.observable(),s=ko.observable(0),p=!1,c=ko.observable(!1),m=ko.observable(!1),l=ko.observable(),u=function(){p||(d(n.createEntity("Character",{})),s(1)),c.subscribe(function(){c(!0)})},T=ko.computed(function(){var e="";return ko.utils.arrayForEach(a.classTypes(),function(a){e+=a.name()+", "}),e=e.substring(0,e.length-2)}),I=function(){c(!0)},g={activate:u,compositionComplete:I,classTypesString:T,create:r,addClass:y,focusNameInput:c,focusClassInput:m,focusIt:i,character:d,className:l,state:s};return g});
define('viewmodels/gameStart/designer',["services/session","services/game.objects","plugins/router","services/datacontext"],function(e,a){function t(){console.log("Activating")}function n(){console.log("Attached")}function i(){newMap={id:o(),name:y(),layout:s()},a.mapCreator(newMap),d(!1),s(null),y(null),o(null)}function r(){}var o=ko.observable(),y=ko.observable(),s=ko.observable(),d=ko.observable(!0),p=a.tileTypes,c=ko.computed(function(){return!o()}),m=ko.computed(function(){return!y()}),l=ko.computed(function(){return!c()&&!m()}),u="******,\n*U...*,\n*....*,\n*....*,\n******",T={activate:t,idValue:o,nameValue:y,attached:n,isNew:d,create:i,mapString:s,exampleString:u,nameIsInvalid:m,idIsInvalid:c,save:r,canSave:l,tileTypes:p};return T});
define('viewmodels/gameStart/game',["services/session","services/datacontext","plugins/router"],function(e,t,a){function n(){return w(e.currentPlayer()),w()?(r(),b(),void 0):a.navigate("")}function i(){if(W()){var e=W().toLowerCase();if(B()){var a=parseInt(e);if(!isNaN(a)){var n=w().weapons()[a-1];n?(w().weapon(n),$("YOU HAVE EQUIPPED A "+n.name())):$("SORRY YOU DONT HAVE THAT WEAPON"),W(null),B(!1)}}else if(!G()||Y())t.getMap(G,e),r(),b(),$("ENTER COMMAND"),W(null),Y(!1);else if("right"===e||"r"===e){if(H())return d("r"),!0;W(null),y()}else if("left"===e||"l"===e){if(H())return d("l"),!0;W(null),P()}else if("up"===e||"u"===e){if(H())return d("u"),!0;W(null),o()}else if("down"===e||"d"===e){if(H())return d("d"),!0;W(null),s()}else"2"===e||"open"===e?(W(null),l()):"3"===e||"search"===e?(W(null),m()):"4"===e||"wield"===e?(W(null),h()):"5"===e||"fight"===e?(W(null),E()):"7"===e||"save"===e?(W(null),p()):"8"===e||"cast"===e?(W(null),T()):"9"===e||"buy magic"===e?(W(null),f()):"10"===e||"load"===e?(W(null),O(e)):"11"===e||"buy hp"===e?(W(null),v()):"0"===e||"pass"===e?(W(null),pass()):($("COME ON"),W(null))}}function r(){if(G()){var e=t.findPlayerStart(G().id());if(t.createPlayerPosition(w(),e.x(),e.y()),w()){var a=w().position(),n=t.getTileByCoord(null,a.x(),a.y(),G().id());n&&(n.image("U"),n.occupied(!0))}}}function o(){var e=w().position();x(e.x(),e.y()-1)}function s(){var e=w().position();x(e.x(),e.y()+1)}function y(){var e=w().position();x(e.x()+1,e.y())}function l(){$("DOOR LEFT RIGHT UP OR DOWN"),H(!0)}function d(e){var t=w().position();"d"===e?u(t.x(),t.y()+1):"u"===e?u(t.x(),t.y()-1):"l"===e?u(t.x()-1,t.y()):"r"===e&&u(t.x()+1,t.y())}function u(e,a){if(w()){w().position();var n=t.getTileByCoord(null,e,a,G().id());n&&(c(n)?(k(n),H(!1),W(null)):alert("THERE ISNT A DOOR THERE..."))}}function c(e){return e.item()&&"DOOR"===e.item().name()?!0:!1}function p(){t.saveMapsAndTiles()}function m(){$("SEARCH.........SEARCH.........SEARCH........."),L(!0)}function T(){$("MAGIC"),w().weapon()?setTimeout($("YOU CANT USE MAGIC WITH WEAPON IN HAND"),100):setTimeout($("YOU CANT USE MAGIC WITH WEAPON IN HAND"),100)}function f(){"FIGHTER"===w().classType().name()?setTimeout($("YOU CANT BUY ANY"),100):(setTimeout($("BUY WHICH"),100),U(!0))}function v(){$("HOW MANY 200 GP. EACH"),K(!0)}function E(){var e=w().weapon();if(e){$("YOUR WEAPON IS "+e.name());var t=S(),a=N(),n=A(a,t);if(n>e.range())$("ENEMY IS TOO FAR AWAY");else if(z(!0),e.range()>1)if("BOW"===e.name()){var i=ko.utils.arrayFirst(w().items(),function(e){return"ARROWS"===e.name()});i&&i.quantity()>0?(I(e),i.quantity(i.quantity()-1)):$("YOU DONT HAVE ANY ARROWS")}else I(e),w().weapons.remove(I),w().weapon(null);else I(e)}else $("YOU DONT HAVE A WEAPON IN HAND")}function I(e){var t=_().name();$(t),setTimeout(function(){$("HP = "+_().hitPoints())},1500),setTimeout(function(){$("SWING ")},1500);var a=g(1,2);a=1==a?!0:!1,a?(setTimeout(function(){$("HIT ENEMY ")},1500),_().hitPoints(_().hitPoints()-e.damage()),_().hitPoints()<1&&(setTimeout(function(){$("KILLED SKELETON ")},1500),z(!1),M(),b())):setTimeout(function(){$("MISSED TOTALY")},1500)}function g(e,t){return Math.round(Math.random()*(t-e)+e)}function b(){if(G()){_(t.createComplexType("TileEnemy",{name:"GOBLIN",hitPoints:10,damage:1}));var e=t.findEnemy(G().id());if(e){if(t.createEnemyPosition(_(),e.x(),e.y()),_()){var a=_().position(),n=t.getTileByCoord(null,a.x(),a.y(),G().id());n&&(n.image("E"),n.occupied(!0),n.enemy(_()))}}else console.log("no more monsters"),$("YOU HAVE CLEARED THE DUNGEON OF MONSTERS")}}function A(e,t){var a=Math.abs(e.x()-t.x()),n=Math.abs(e.y()-t.y()),i=a>n?a:n;return i}function N(){var e;if(w()){var a=w().position();e=t.getTileByCoord(null,a.x(),a.y(),G().id())}return e}function S(){if(_()){var e=_().position(),a=t.getTileByCoord(null,e.x(),e.y(),G().id());return a}return null}function O(){Y(!0),$("ENTER DUNGEON #")}function h(){$("WHICH WEAPON WILL YOU HOLD, NUM OF WEAPON"),B(!0)}function P(){var e=w().position();x(e.x()-1,e.y())}function x(e,a){if(w()){var n=w().position(),i=t.getTileByCoord(null,n.x(),n.y(),G().id()),r=t.getTileByCoord(null,e,a,G().id());r&&(D(r)||(k(i),C(r),R(r)))}}function C(e){if(e.item()&&e.item().name()){var t=e.item();$("FOUND A "+t.name()+" ITEM!"),e.item().id(null),e.item().name(null),e.item().value(null),t.value()&&w().gold(w().gold()+t.value())}else $("ENTER COMMAND")}function D(e){return e.occupied()}function k(e){e.occupied(!1),e.image(" "),e.item()&&(e.item().id(null),e.item().name(null),e.item().value(null)),e.enemy()&&e.enemy().id()&&(e.enemy().id(null),e.enemy().name(null),e.enemy().hitPoints(null),e.enemy().position().x(null),e.enemy().position().y(null))}function M(){var e=S();k(e)}function R(e){e.occupied(!0),e.image("U"),w().position().x(e.x()),w().position().y(e.y())}var w=ko.observable(),G=ko.observable(),W=ko.observable(),H=ko.observable(),L=ko.observable(),K=ko.observable(),U=ko.observable(),B=ko.observable(),Y=ko.observable(),z=ko.observable(),F=ko.observable(10),V=ko.observable(10),_=ko.observable(),Q=["U,D,L,R - MOVE","2 - OPEN DOOR","3 - SEARCH (TRAPS, DOORS)","4 - SWITCH WEAPON","5 - FIGHT","7 - SAVE GAME","8 - USE MAGIC","9 - BUY MAGIC","10 - LOAD DUNGEON","11 - BUY HP","0 - PASS;"],$=ko.observable("WHICH DUNGEON # (2 - DEFAULT) "),j=ko.observable(!1),q=ko.computed(function(){var e={};if(w()&&G()){var t=w().position(),a=t.y()+Math.ceil(F()/2),n=t.x()-Math.ceil(V()/2),i=a-F(),r=n+V(),o=function(e,t){return e.x()==t.x()?e.x()>t.x()?1:-1:e.x()>t.x()?1:-1};e.rows=ko.computed(function(){var e=G().tiles(),t=[],s=[];return ko.utils.arrayForEach(e,function(e){e.y()>=i&&e.y()<=a&&-1===t.indexOf(e.y())&&t.push(e.y())}),ko.utils.arrayForEach(t,function(t){var a=ko.utils.arrayFilter(e,function(e){return e.x()>=n&&e.x()<=r&&t===e.y()}).sort(o);s.push(a)}),s}).extend({throttle:25})}else e.rows=ko.observableArray([]);return e}),X=function(){j(!0)},Z={activate:n,compositionComplete:X,enterCommand:i,focusGameInput:j,gameInput:W,instructions:Q,gameMessage:$,map:G,player:w,centeredMap:q};return Z});
define('viewmodels/gameStart/purchase',["services/session","services/game.objects","plugins/router","services/datacontext"],function(e,t,a,n){function i(){u(e.currentPlayer()),u()||a.navigate("")}function r(){y(1)}function o(){return d()?("FAST"===d()?console.log("IT DOESN'T MATTER WHAT YOU TYPE!"):console.log("IT DOESN'T MATTER WHAT YOU TYPE!"),y(2)):void 0}function s(){if(p()){var e=p().toLowerCase();if(3===y()&&"-1"===e||3===y()&&"done"===e)return a.navigate("game");var t=ko.utils.arrayFirst(T(),function(t){return t.name().toLowerCase()===e});if(!t&&(t=ko.utils.arrayFirst(T(),function(e){return e.id()==p()}),!t))return p(null),!1;if(!(t.value()>u().gold()))return u().items.push(t),u().gold(u().gold()-t.value()),n.saveEntity(u()),p(null),!0;alert("COSTS TOO MUCH TRY AGAIN!")}}function l(){if(c()){var e=c().toLowerCase();("-1"===e||"done"===e)&&y(3);var a=ko.utils.arrayFirst(t.weapons(),function(t){return t.name().toLowerCase()===e});if(!a&&(a=ko.utils.arrayFirst(t.weapons(),function(t){return t.id()==e}),!a))return c(null),!1;if(!(a.value()>u().gold()))return u().weapons.push(a),u().gold(u().gold()-a.value()),n.saveEntity(u()),c(null),!0;alert("COSTS TOO MUCH TRY AGAIN!")}}var u=ko.observable(),y=ko.observable(),d=ko.observable(),c=ko.observable(),p=ko.observable(),m=t.weapons(),T=ko.computed(function(){var e=[];return e=ko.utils.arrayFilter(t.items(),function(e){return e.canBuy()===!0})}),f={player:u,activate:i,attached:r,weaponName:c,itemName:p,fastOrNorm:d,chooseFastOrNorm:o,addWeapon:l,addItem:s,state:y,weaponTypes:m,items:T};return f});
...
define('plugins/dialog',["durandal/system","durandal/app","durandal/composition","durandal/activator","durandal/viewEngine","jquery","knockout"],function(e,t,n,a,i,r,o){function s(t){return e.defer(function(n){e.isString(t)?e.acquire(t).then(function(t){n.resolve(e.resolveObject(t))}).fail(function(n){e.error("Failed to load dialog module ("+t+"). Details: "+n.message)}):n.resolve(t)}).promise()}var c,l={},u=0,d=function(e,t,n){this.message=e,this.title=t||d.defaultTitle,this.options=n||d.defaultOptions};return d.prototype.selectOption=function(e){c.close(this,e)},d.prototype.getView=function(){return i.processMarkup(d.defaultViewMarkup)},d.setViewUrl=function(e){delete d.prototype.getView,d.prototype.viewUrl=e},d.defaultTitle=t.title||"Application",d.defaultOptions=["Ok"],d.defaultViewMarkup=['<div data-view="plugins/messageBox" class="messageBox">','<div class="modal-header">','<h3 data-bind="text: title"></h3>',"</div>",'<div class="modal-body">','<p class="message" data-bind="text: message"></p>',"</div>",'<div class="modal-footer" data-bind="foreach: options">','<button class="btn" data-bind="click: function () { $parent.selectOption($data); }, text: $data, css: { \'btn-primary\': $index() == 0, autofocus: $index() == 0 }"></button>',"</div>","</div>"].join("\n"),c={MessageBox:d,currentZIndex:1050,getNextZIndex:function(){return++this.currentZIndex},isOpen:function(){return u>0},getContext:function(e){return l[e||"default"]},addContext:function(e,t){t.name=e,l[e]=t;var n="show"+e.substr(0,1).toUpperCase()+e.substr(1);this[n]=function(t,n){return this.show(t,n,e)}},createCompositionSettings:function(e,t){var n={model:e,activate:!1,transition:!1};return t.attached&&(n.attached=t.attached),t.compositionComplete&&(n.compositionComplete=t.compositionComplete),n},getDialog:function(e){return e?e.__dialog__:void 0},close:function(e){var t=this.getDialog(e);if(t){var n=Array.prototype.slice.call(arguments,1);t.close.apply(t,n)}},show:function(t,i,r){var o=this,c=l[r||"default"];return e.defer(function(e){s(t).then(function(t){var r=a.create();r.activateItem(t,i).then(function(a){if(a){var i=t.__dialog__={owner:t,context:c,activator:r,close:function(){var n=arguments;r.deactivateItem(t,!0).then(function(a){a&&(u--,c.removeHost(i),delete t.__dialog__,0===n.length?e.resolve():1===n.length?e.resolve(n[0]):e.resolve.apply(e,n))})}};i.settings=o.createCompositionSettings(t,c),c.addHost(i),u++,n.compose(i.host,i.settings)}else e.resolve(!1)})})}).promise()},showMessage:function(t,n,a){return e.isString(this.MessageBox)?c.show(this.MessageBox,[t,n||d.defaultTitle,a||d.defaultOptions]):c.show(new this.MessageBox(t,n,a))},install:function(e){t.showDialog=function(e,t,n){return c.show(e,t,n)},t.showMessage=function(e,t,n){return c.showMessage(e,t,n)},e.messageBox&&(c.MessageBox=e.messageBox),e.messageBoxView&&(c.MessageBox.prototype.getView=function(){return e.messageBoxView})}},c.addContext("default",{blockoutOpacity:.2,removeDelay:200,addHost:function(e){var t=r("body"),n=r('<div class="modalBlockout"></div>').css({"z-index":c.getNextZIndex(),opacity:this.blockoutOpacity}).appendTo(t),a=r('<div class="modalHost"></div>').css({"z-index":c.getNextZIndex()}).appendTo(t);if(e.host=a.get(0),e.blockout=n.get(0),!c.isOpen()){e.oldBodyMarginRight=t.css("margin-right"),e.oldInlineMarginRight=t.get(0).style.marginRight;var i=r("html"),o=t.outerWidth(!0),s=i.scrollTop();r("html").css("overflow-y","hidden");var l=r("body").outerWidth(!0);t.css("margin-right",l-o+parseInt(e.oldBodyMarginRight,10)+"px"),i.scrollTop(s)}},removeHost:function(e){if(r(e.host).css("opacity",0),r(e.blockout).css("opacity",0),setTimeout(function(){o.removeNode(e.host),o.removeNode(e.blockout)},this.removeDelay),!c.isOpen()){var t=r("html"),n=t.scrollTop();t.css("overflow-y","").scrollTop(n),e.oldInlineMarginRight?r("body").css("margin-right",e.oldBodyMarginRight):r("body").css("margin-right","")}},attached:function(e){r(e).css("visibility","hidden")},compositionComplete:function(e,t,n){var a=c.getDialog(n.model),i=r(e),o=i.find("img").filter(function(){var e=r(this);return!(this.style.width&&this.style.height||e.attr("width")&&e.attr("height"))});i.data("predefinedWidth",i.get(0).style.width);var s=function(){setTimeout(function(){i.data("predefinedWidth")||i.css({width:""});var e=i.outerWidth(!1),t=i.outerHeight(!1),n=r(window).height(),o=Math.min(t,n);i.css({"margin-top":(-o/2).toString()+"px","margin-left":(-e/2).toString()+"px"}),i.data("predefinedWidth")||i.outerWidth(e),t>n?i.css("overflow-y","auto"):i.css("overflow-y",""),r(a.host).css("opacity",1),i.css("visibility","visible"),i.find(".autofocus").first().focus()},1)};s(),o.load(s),i.hasClass("autoclose")&&r(a.blockout).click(function(){a.close()})}}),c});
...
define('plugins/observable',["durandal/system","durandal/binder","knockout"],function(e,t,n){function a(e){var t=e[0];return"_"===t||"$"===t}function i(t){return!(!t||void 0===t.nodeType||!e.isNumber(t.nodeType))}function r(e){if(!e||i(e)||e.ko===n||e.jquery)return!1;var t=p.call(e);return-1==f.indexOf(t)&&!(e===!0||e===!1)}function o(e,t){var n=e.__observable__,a=!0;if(!n||!n.__full__){n=n||(e.__observable__={}),n.__full__=!0,v.forEach(function(n){e[n]=function(){a=!1;var e=h[n].apply(t,arguments);return a=!0,e}}),m.forEach(function(n){e[n]=function(){a&&t.valueWillMutate();var i=g[n].apply(e,arguments);return a&&t.valueHasMutated(),i}}),y.forEach(function(n){e[n]=function(){for(var i=0,r=arguments.length;r>i;i++)s(arguments[i]);a&&t.valueWillMutate();var o=g[n].apply(e,arguments);return a&&t.valueHasMutated(),o}}),e.splice=function(){for(var n=2,i=arguments.length;i>n;n++)s(arguments[n]);a&&t.valueWillMutate();var r=g.splice.apply(e,arguments);return a&&t.valueHasMutated(),r};for(var i=0,r=e.length;r>i;i++)s(e[i])}}function s(t){var i,s;if(r(t)&&(i=t.__observable__,!i||!i.__full__)){if(i=i||(t.__observable__={}),i.__full__=!0,e.isArray(t)){var c=n.observableArray(t);o(t,c)}else for(var u in t)a(u)||i[u]||(s=t[u],e.isFunction(s)||l(t,u,s));T&&e.log("Converted",t)}}function c(e,t,n){var a;e(t),a=e.peek(),n?a?a.destroyAll||o(a,e):(a=[],e(a),o(a,e)):s(a)}function l(t,a,i){var r,l,u=t.__observable__||(t.__observable__={});if(void 0===i&&(i=t[a]),e.isArray(i))r=n.observableArray(i),o(i,r),l=!0;else if("function"==typeof i){if(!n.isObservable(i))return null;r=i}else e.isPromise(i)?(r=n.observable(),i.then(function(t){if(e.isArray(t)){var a=n.observableArray(t);o(t,a),t=a}r(t)})):(r=n.observable(i),s(i));return Object.defineProperty(t,a,{configurable:!0,enumerable:!0,get:r,set:n.isWriteableObservable(r)?function(t){t&&e.isPromise(t)?t.then(function(t){c(r,t,e.isArray(t))}):c(r,t,l)}:void 0}),u[a]=r,r}function u(t,a,i){var r,o={owner:t,deferEvaluation:!0};return"function"==typeof i?o.read=i:("value"in i&&e.error('For defineProperty, you must not specify a "value" for the property. You must provide a "get" function.'),"function"!=typeof i.get&&e.error('For defineProperty, the third parameter must be either an evaluator function, or an options object containing a function called "get".'),o.read=i.get,o.write=i.set),r=n.computed(o),t[a]=r,l(t,a,r)}var d,p=Object.prototype.toString,f=["[object Function]","[object String]","[object Boolean]","[object Number]","[object Date]","[object RegExp]"],v=["remove","removeAll","destroy","destroyAll","replace"],m=["pop","reverse","sort","shift","splice"],y=["push","unshift"],g=Array.prototype,h=n.observableArray.fn,T=!1;return d=function(e,t){var a,i,r;return e?(a=e.__observable__,a&&(i=a[t])?i:(r=e[t],n.isObservable(r)?r:l(e,t,r))):null},d.defineProperty=u,d.convertProperty=l,d.convertObject=s,d.install=function(e){var n=t.binding;t.binding=function(e,t,a){a.applyBindings&&!a.skipConversion&&s(e),n(e,t)},T=e.logConversion},d});
...
define('transitions/entrance',["durandal/system","durandal/composition","jquery"],function(e,t,n){var i=100,a={marginRight:0,marginLeft:0,opacity:1},r={marginLeft:"",marginRight:"",opacity:"",display:""},o=function(t){return e.defer(function(e){function o(){e.resolve()}function s(){t.keepScrollPosition||n(document).scrollTop(0)}function u(){s(),t.triggerAttach();var e={marginLeft:l?"0":"20px",marginRight:l?"0":"-20px",opacity:0,display:"block"},i=n(t.child);i.css(e),i.animate(a,{duration:c,easing:"swing",always:function(){i.css(r),o()}})}if(t.child){var c=t.duration||500,l=!!t.fadeOnly;t.activeView?n(t.activeView).fadeOut({duration:i,always:u}):u()}else n(t.activeView).fadeOut(i,o)}).promise()};return o});
